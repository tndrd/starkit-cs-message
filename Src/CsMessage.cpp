...
void CsMessageOut::makeQueryControlEx(int id, int value, int reserv16)
  {
  beginQuery( CS_CMD_MSG_CONTROL, id );
  addInt16( value );
  addInt16( reserv16 );
...
void CsMessageOut::makeAnswerControlEx(int angle, int pwm, int velo, int reserv8, int flags)
  {
  beginAnswer();
  addInt16( angle );
  addInt16( pwm );
